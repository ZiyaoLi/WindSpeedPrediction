...
p = np.zeros([6,len_data-96*N_days,N_pred*3])
...
for i in range(6):
    ...
    p[i,:,0:3] = pred_data[96*N_days:len_data,:]
    p[i,:,3:6] = pred_data[96*N_days-1:len_data-1,:]
    p[i, :-1, 6:9] = pred_data[96 * N_days + 1:len_data, :]
    p[i,-1,6:9] = pred_data[len_data-1, :]
